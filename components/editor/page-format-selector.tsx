...
import { FileText, Bookmark, Book, BookOpen, Monitor } from "lucide-react"
import {
  Select,
  SelectContent,
  SelectItem,
...
export function PageFormatSelector({
  ...
  const selectedOption = pageFormatOptions.find(option => option.value === currentValue)
