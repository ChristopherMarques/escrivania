...
export function ChapterEditor({ chapterId, onBack }: ChapterEditorProps) {
  const { state, updateChapter, createScene, updateScene, deleteScene } =
    useProject();
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isEditing
              ? "Edite o título e conteúdo do capítulo"
              : "Visualize e gerencie o conteúdo do capítulo"}
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4">
              {chapter.description ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>
                    Nenhuma descrição ainda. Clique em "Editar" para começar a
                    escrever.
                  </p>
                </div>
              )}
        ...
        {chapterScenes.length === 0 ? (
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                Organize seu capítulo em cenas para facilitar a escrita e
                revisão.
              </p>
            </CardContent>
          </Card>
                  ...
                  <div className="space-y-2">
                    {scene.content ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">
                        Cena sem conteúdo. Clique em editar para começar a
                        escrever.
                      </p>
                    )}
                  </div>
